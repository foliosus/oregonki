...
Lightbox.prototype = {
	...
	initialize: function() {	
		...
		var objCaption = document.createElement("h3");
		objCaption.setAttribute('id','caption');
		objImageDetails.appendChild(objCaption);
	
		var objNumberDisplay = document.createElement("p");
	...
	updateDetails: function() {
		...
		if(imageArray.length > 1){
			...
			Element.setInnerHTML( 'numberDisplay', "Image " + eval(activeImage + 1) + " of " + imageArray.length + ". Use &quot;N&quot; and &quot;P&quot; to navigate between images, or &quot;X&quot; to return to the web page.");
		}
